...
<div class="wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="innerDiv">
                                ...
                                <div class="vGif vGif1" style="display:none;">
                                	<img src="{{asset('mobile/images/v1.jpg')}}" />
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="innerDiv">
                                ...
                                <div class="vGif vGif2" style="display:none;">
                                	<img src="{{asset('mobile/images/v2.jpg')}}" />
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="innerDiv">
                                ...
                                <video id="v3" class="v3" src="{{asset('pc/images/v3.mp4')}}" preload="auto" style="display:none;"></video>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="innerDiv">
                                <a href="javascript:void(0);" vir='4'><img src="{{asset('mobile/images/l14.jpg')}}"></a>
                                <video id="v4" class="v4" src="{{asset('pc/images/v4.mp4')}}" preload="auto" style="display:none;"></video>
                            </div>
                        </div>
                    </div>
                </div>
        	...
        	<div class="abs fBlock">
                    ...
                    <div class="f3" style="display:none;">
                        <div class="innerDiv">
                            ...
                            <a href="http://m.ikea.com/cn/zh/pages/activity/2016_awgc/" onClick="ga('send','event','UGC Recruitment','Click','Go_Cooking_With_Children');" target="_top" class="abs moreLink"><img src="{{asset('mobile/images/space.gif')}}" width="120" height="28"></a>
                        </div>
                    </div>
    ...
    <div class="line4">
    	<div class="innerDiv">
        	<a href="javascript:void(0);" onClick="showL3Pop(1);ga('send','event','p3banner_mobile','click','p3banner-block_1_m');" class="abs l3Btn1"><img src="{{asset('mobile/images/space.gif')}}" width="190" height="190"></a>
            <a href="javascript:void(0);" onClick="showL3Pop(2);ga('send','event','p3banner_mobile','click','p3banner-block_2_m');" class="abs l3Btn2"><img src="{{asset('mobile/images/space.gif')}}" width="190" height="190"></a>
            <a href="javascript:void(0);" onClick="showL3Pop(3);ga('send','event','p3banner_mobile','click','p3banner-block_3_m');" class="abs l3Btn3"><img src="{{asset('mobile/images/space.gif')}}" width="190" height="190"></a>
            <a href="javascript:void(0);" onClick="showL3Pop(4);ga('send','event','p3banner_mobile','click','p3banner-block_4_m');" class="abs l3Btn4"><img src="{{asset('mobile/images/space.gif')}}" width="190" height="190"></a>
            <a href="javascript:void(0);" onClick="showL3Pop(5);ga('send','event','p3banner_mobile','click','p3banner-block_5_m');" class="abs l3Btn5"><img src="{{asset('mobile/images/space.gif')}}" width="190" height="190"></a>
            <div class="abs l3Pop l3Pop1" style="display:none;">
                <div class="innerDiv">
                    <a href="http://m.ikea.com/cn/zh/catalog/products/art/10252021/" onClick="ga('send','event','p3banner_mobile','click','p3banner-block_1_gotourl_m');" class="abs l3Gif"><img src="{{asset('mobile/images/l3G1.gif')}}">
            ...
            <div class="abs l3Pop l3Pop2" style="display:none;">
                <div class="innerDiv">
                    <a href="http://m.ikea.com/cn/zh/catalog/products/art/40319973/" onClick="ga('send','event','p3banner_mobile','click','p3banner-block_2_gotourl_m');" class="abs l3Gif"><img src="{{asset('mobile/images/l3G2.gif')}}">
                    <a href="javascript:void(0);" onClick="closeL3Pop();" class="abs l3CloseBtn"><img src="{{asset('mobile/images/l3CloseBtn.png')}}"></a>
                </div>
            </div>
            <div class="abs l3Pop l3Pop3" style="display:none;">
                <div class="innerDiv">
                    <a href="http://m.ikea.com/cn/zh/catalog/products/art/80296601/" onClick="ga('send','event','p3banner_mobile','click','p3banner-block_3_gotourl_m');" class="abs l3Gif"><img src="{{asset('mobile/images/l3G3.gif')}}">
                    <a href="javascript:void(0);" onClick="closeL3Pop();" class="abs l3CloseBtn"><img src="{{asset('mobile/images/l3CloseBtn.png')}}"></a>
                </div>
            </div>
            <div class="abs l3Pop l3Pop4" style="display:none;">
                <div class="innerDiv">
                    <a href="http://m.ikea.com/cn/zh/catalog/products/art/90258953/" onClick="ga('send','event','p3banner_mobile','click','p3banner-block_4_gotourl_m');" class="abs l3Gif"><img src="{{asset('mobile/images/l3G4.gif')}}">
                    <a href="javascript:void(0);" onClick="closeL3Pop();" class="abs l3CloseBtn"><img src="{{asset('mobile/images/l3CloseBtn.png')}}"></a>
                </div>
            </div>
            <div class="abs l3Pop l3Pop5" style="display:none;">
                <div class="innerDiv">
                    <a href="http://m.ikea.com/cn/zh/catalog/products/art/40169450/" onClick="ga('send','event','p3banner_mobile','click','p3banner-block_5_gotourl_m');" class="abs l3Gif"><img src="{{asset('mobile/images/l3G5.gif')}}">
                    <a href="javascript:void(0);" onClick="closeL3Pop();" class="abs l3CloseBtn"><img src="{{asset('mobile/images/l3CloseBtn.png')}}"></a>
                </div>
            </div>
        </div>
